...
export const metadata: Metadata = {
  ...
  description:
    'Deborah Rose Miller owned a financial planning firm for twenty-five years, served nine years on the Magnolia ISD school board, helped write the City of Magnolia’s first comprehensive plan, and now sells homes across the Lake Houston area and Montgomery County.',
...
const SERVICE = [
  ...
  { name: 'Rotary', detail: 'Founding member, Magnolia Rotary Club; member, Summer Creek Rotary Club' },
...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="pt-14 pb-20 sm:pt-20 lg:pb-28">
        <Container>
          <div className="lg:grid lg:grid-cols-12 lg:gap-x-12">
            <div className="lg:col-span-7">
              ...
              <div className="mt-10 max-w-2xl space-y-6 text-lg/8 text-ink-soft">
                ...
                <p>
                  ...
                  independent contractor. In that time I helped write Magnolia&rsquo;s first comprehensive plan, worked
                  directly with developers, and sat in the meetings where zoning and the city&rsquo;s boundaries were
                  decided. Before that I had served nine years on the Magnolia ISD school board, two of them as
                  president.
                </p>
                <p>
                ...
                <p>
                  ...
                  Most of the people I work with today came through someone I already know, and the clients I enjoy most
                  are the ones who let me use what I know on their behalf.
                </p>
              </div>
            </div>
            <div className="mt-12 lg:col-span-4 lg:col-start-9 lg:mt-0">
              ...
              />
              <dl className="mt-8 divide-y divide-rule border-y border-rule text-sm/6">
                {CREDENTIALS.map((c) => (
        ...
        <Container>
          <div className="lg:grid lg:grid-cols-12 lg:gap-x-12">
            <div className="lg:col-span-5">
              ...
              <Heading className="mt-6">Three careers, one client.</Heading>
            </div>
            <dl className="mt-10 space-y-10 lg:col-span-7 lg:mt-0">
              <div>
                <dt className="font-display text-2xl text-ink">Financing</dt>
                <dd className="mt-3 text-base/7 text-ink-soft">
                  ...
                  which ones handle self-employed borrowers well. I am selective about who I send you to for exactly that
                  reason.
                </dd>
              </div>
              <div>
                <dt className="font-display text-2xl text-ink">Zoning, HOAs and city hall</dt>
                <dd className="mt-3 text-base/7 text-ink-soft">
                  When a purchase turns on what a city is planning, what an HOA can enforce or how a boundary was drawn,
                  I have sat on the side of the table that decided it. That is a different kind of answer than a search
                  result.
                </dd>
              </div>
              <div>
                <dt className="font-display text-2xl text-ink">School districts</dt>
                <dd className="mt-3 text-base/7 text-ink-soft">
                  Nine years as a trustee taught me how a district is run, funded and drawn. I can tell you how
                  attendance boundaries work, where to find the state&rsquo;s own report on any campus, and what
                  questions to ask the district directly.
                </dd>
              </div>
            </dl>
          </div>
        ...
        <Container>
          <div className="lg:grid lg:grid-cols-12 lg:gap-x-12">
            <div className="lg:col-span-5">
              ...
              <Heading className="mt-6">Where I have served.</Heading>
