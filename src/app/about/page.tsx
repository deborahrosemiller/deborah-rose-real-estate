      ...
      <div className="relative bg-field">
        <div className="mx-auto max-w-7xl lg:flex lg:justify-between lg:px-8 xl:justify-end">
          <div className="lg:flex lg:w-1/2 lg:shrink lg:grow-0 xl:absolute xl:inset-y-0 xl:right-1/2 xl:w-1/2">
            {/* Sticky and viewport-tall from lg, so the portrait is always whole rather than stretched to the length of the biography. */}
            <div className="relative h-96 lg:sticky lg:top-[var(--nav-h)] lg:-ml-8 lg:h-[calc(100svh-var(--nav-h))] lg:w-full lg:grow xl:ml-0">
              <Image src={agent.headshot} alt={agent.headshotAlt} fill priority sizes="(min-width: 1024px) 50vw, 100vw" className="bg-paper object-cover object-[50%_25%] grayscale" />
            </div>
          </div>
